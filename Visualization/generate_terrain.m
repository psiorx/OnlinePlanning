function [x, y, h, hm, xm, ym] = generate_terrain(n, mesh_size, h0, r0, rr, xlims, ylims)
...
% Copyright 2012, The MathWorks, Inc.
    ...
    if nargout > 3 && ~isempty(mesh_size)
        [xm, ym] = meshgrid(linspace(xlims(1), xlims(2), mesh_size),linspace(ylims(1), ylims(2), mesh_size));
