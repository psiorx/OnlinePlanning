classdef SBachPlant_world < DrakeSystem
    ...
    methods
        ...
        function xdot = dynamics(obj,t,x,u)
            ...
            % Convert to model frame
            x = ConvertToModelFrameFromWorldFrame(x);
            ...
            xdot = ConvertToWorldCoords(xdot, R_body_to_world, rpy, [U;V;W], [P;Q;R]);
            ...
            function xdot_world = ConvertToWorldCoords(xdot, R_body_to_world, rpy, uvw, pqr)
                ...
                [Phi0, dPhi] = angularvel2rpydotMatrix([phi;theta;psi]);
                ...
                xdot_world = [xyzdot0; rpydot0; xyz_ddot_world; rpy_ddot];
            end
            
            
            function x_body = ConvertToModelFrameFromWorldFrame(x0_drake)
                x_body = 0*x0_drake;
                x_body(1:6,:) = x0_drake(1:6);
                % body position is always at origin in body frame
                %x_body(1) = 0;
                %x_body(2) = 0;
                %x_body(3) = 0;
                rpy0 = [ x0_drake(4); x0_drake(5); x0_drake(6)];
                rpydot0 = x0_drake(10:12);
